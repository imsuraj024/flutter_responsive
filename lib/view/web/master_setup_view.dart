...
class MasterSetupView extends StatelessWidget {
  final brands = Master.getMaster();

  MasterSetupView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final isTabletDesktop = Responsive.isDesktop(context);
